...
Use "es" key (not "it", "en", or "fr") for Spanish content in all Bilingual fields. Do NOT include a "vocabulary" field:
{
  ...
  "dialogue": {"title": {"es": "...", "pl": "..."}, "setting": {"es": "...", "pl": "..."}, "lines": [{"speaker": "...", "text": {"es": "...", "pl": "..."}, "tone": "neutral|happy|surprised|formal|casual|ironic|questioning|emphatic", "annotation": {"es": "...", "pl": "..."}, "grammar_note": {"es": "...", "pl": "..."}}], "vocabulary_highlight": ["..."]},
...
Use "de" key (not "it", "en", "fr", or "es") for German content in all Bilingual fields. Do NOT include a "vocabulary" field:
{
  ...
  "dialogue": {"title": {"de": "...", "pl": "..."}, "setting": {"de": "...", "pl": "..."}, "lines": [{"speaker": "...", "text": {"de": "...", "pl": "..."}, "tone": "neutral|happy|surprised|formal|casual|ironic|questioning|emphatic", "annotation": {"de": "...", "pl": "..."}, "grammar_note": {"de": "...", "pl": "..."}}], "vocabulary_highlight": ["..."]},
...
Use "cs" key (not "it", "en", "fr", "es", or "de") for Czech content in all Bilingual fields. Do NOT include a "vocabulary" field:
{
  ...
  "dialogue": {"title": {"cs": "...", "pl": "..."}, "setting": {"cs": "...", "pl": "..."}, "lines": [{"speaker": "...", "text": {"cs": "...", "pl": "..."}, "tone": "neutral|happy|surprised|formal|casual|ironic|questioning|emphatic", "annotation": {"cs": "...", "pl": "..."}, "grammar_note": {"cs": "...", "pl": "..."}}], "vocabulary_highlight": ["..."]},
...
Use "ru" key (not "it", "en", "fr", "es", "de", or "cs") for Russian content in all Bilingual fields. Do NOT include a "vocabulary" field:
{
  ...
  "dialogue": {"title": {"ru": "...", "pl": "..."}, "setting": {"ru": "...", "pl": "..."}, "lines": [{"speaker": "...", "text": {"ru": "...", "pl": "..."}, "tone": "neutral|happy|surprised|formal|casual|ironic|questioning|emphatic", "annotation": {"ru": "...", "pl": "..."}, "grammar_note": {"ru": "...", "pl": "..."}}], "vocabulary_highlight": ["..."]},
...
Use "pt" key (not "it", "en", "fr", "es", "de", "cs", or "ru") for Portuguese content in all Bilingual fields. Do NOT include a "vocabulary" field:
{
  ...
  "dialogue": {"title": {"pt": "...", "pl": "..."}, "setting": {"pt": "...", "pl": "..."}, "lines": [{"speaker": "...", "text": {"pt": "...", "pl": "..."}, "tone": "neutral|happy|surprised|formal|casual|ironic|questioning|emphatic", "annotation": {"pt": "...", "pl": "..."}, "grammar_note": {"pt": "...", "pl": "..."}}], "vocabulary_highlight": ["..."]},
